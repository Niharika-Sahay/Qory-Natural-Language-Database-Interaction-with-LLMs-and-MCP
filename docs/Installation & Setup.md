...
>[!NOTE]
> If you have less than 8GB RAM and No GPU in you system, install Gemma 7B. Otherwise, Gemma3 12B could be installed if you have available RAM higher than 9.2 GB.
